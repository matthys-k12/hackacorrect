...
// import esaticC2e from "../assets/images/logoC2E.jpg";
// import logoEsatic from "../assets/images/logoEsatic.png";
...
export default function Footer() {
  return (
    ...
    //     <div className="rounded-lg m-4 dark:bg-gray-800">
    //       <div className="w-full mx-auto max-w-screen-xl p-4 md:flex justify-center md:items-center md:justify-between">
    //         <span className="text-sm text-center text-[#434343] sm:text-center dark:text-gray-400">
    //           © 2025{" "}
    ...
    //           <li className="ml-4">
    //             <img className="h-7" src={esaticC2e} alt="" />
    //           </li>
    //           <li className="mx-4">
    //             <img className="h-7" src={logoEsatic} alt="" />
    //           </li>
    //         </ul>
    //       </div>
    //     </div>
